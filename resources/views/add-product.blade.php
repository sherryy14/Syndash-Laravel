                          ...
                          <div class="card-body p-6 ">
                            ...
                            <div class="row">
                              ...
                              <div class="mb-3 col-lg-6">
                               ...
                               <input type="number" name="unit" min="1" class="form-control" placeholder="Unit" required>
                              </div>
                              <div>
                                <div class="mb-3 col-lg-12 mt-5">
                                  ...
                                  <!-- input -->
                                    ...
                                    <div class="fallback">
                                      <input name="file1" type="file" class="form-control my-2" accept="image/png, image/gif, image/jpeg" required> 
                                      <input name="file2" type="file" class="form-control my-2" accept="image/png, image/gif, image/jpeg" required> 
                                      <input name="file3" type="file" class="form-control my-2" accept="image/png, image/gif, image/jpeg" required>
                                      <input name="file4" type="file" class="form-control my-2" accept="image/png, image/gif, image/jpeg" required>
                                    </div>
                              ...
                              <div class="mb-3 col-lg-12 mt-5">
                                ...
                                tor"></div> -->
                                <textarea name="desc" placeholder="Write description" cols="30" rows="5" required class="form-control"></textarea> 
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card-body p-6">
                            ...
                            <div>
                              <div class="mb-3">
                                ...
                                <input type="text" required name="code" class="form-control" placeholder="Enter Product Title">
                              </div>
